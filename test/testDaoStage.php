...
<html>
    ...
    <body>
        ...
        $etudiant= new M_Personne(0, $spe, $roleE, "M.", "Hugo", "Victor", "0278901234", "vhugo@free.fr", "0678901234", "", "", "vhugo", "vh");

        $roleP = new M_Role(150, 3, "prof");
        $prof = new M_Personne(252, $spe, $roleP, "M.", "AA", "AAA", "0202020202", "a@free.fr", null, null, null, "aa", "aa");

        $roleM = new M_Role(150, 5, "maître de stage");
        $maitre = new M_Personne(322, $spe, $roleM, "M.", "BB", "BBB", "0202020202", "b@gmail.com", null, null, null, "bb", "bb");
